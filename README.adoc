...
:url-lmi-options-octave-entry: https://github.com/niveK77pur/lilypond-midi-input#options-octave-entry
:url-lmi-options-language: https://github.com/niveK77pur/lilypond-midi-input#options-language
...
==== Lilypond `octave_entry` for notes

Set the input octave entry for the backend. See {url-lmi-options-octave-entry}[pass:q[`lilypond-midi-input`]'s options table].
...
==== Lilypond note `language`

Set the note language for the backend. See {url-lmi-options-language}[pass:q[`lilypond-midi-input`]'s options table].
